...
var t = function (a, b) {
    ...
    proficiencydata = d3
        ...
        .value(function (a) {console.log('ohhhhhhhh '+a.value); return a.value }),
    arc = d3.svg
        .arc()
...
function pieChart(percentage) {
   console.log(percentage);
    ...
    d.push(40);
   d.push(30);
   console.log('Coming from cust func '+x1+' '+y1+' '+x2+' '+y2);
    return d;
}
...
var tempMergeObj = {};
var indexCounter = 0;
for(var key in skillsdataRaw)
{
   var temp = {};
   temp['"'+key+'"'] = {};
   for( var subKey in skillsdataRaw[key])
   {
     var arr=[];
     arr = pieChart(skillsdataRaw[key][subKey]);
     temp['"'+key+'"']['"'+subKey+'"'] = arr;
   }
   skillsdata.Skills['"'+key+'"'] = temp['"'+key+'"'];
   indexCounter++;
}
...
path
    ...
    .attr("d", arc)
    .attr("stroke", "#fff")
    .attr("fill", function (a) {console.log(a.x, a.dx, a.depth,a.key, a.children); return a._color = q(a), a._color })
